...
model.load_weights('C:\\Users\\khandelwalr\\Mask_RCNN\\mask_rcnn_coco.h5', 
                   by_name=True, 
...
train_set.load_dataset('C:\\Users\\khandelwalr\\Kangaroo\\kangaroo-master\\kangaroo-master', is_train=True)
train_set.prepare()
print('Train: %d' % len(train_set.image_ids))
# prepare test/val set
test_set = KangarooDataset()
test_set.load_dataset('C:\\Users\\khandelwalr\\Kangaroo\\kangaroo-master\\kangaroo-master', is_train=False)
test_set.prepare()
...
train_layers = model.get_trainable_layers()

model_path = 'C:\\Users\\khandelwalr\\Kangaroo\\kangaroo-master\\kangaroo-master\\mask_rcnn_'  + '.' + str(time.time()) + '.h5'
...
model.load_weights(model_path, by_name=True)
img = load_img("C:\\Users\khandelwalr\\Kangaroo\\kangaroo-master\\kangaroo-master\\images\\00042.jpg")
